...
(async () => {
  ...
  await fs.writeFile("international-normalized-ratio-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("international-normalized-ratio-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
